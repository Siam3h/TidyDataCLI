...
@click.group(
    ...
    \b
    tidydata visualize --help   # View commands for data visualization
    tidydata clean --help       # View commands for data cleaning
    tidydata report --help      # View commands for report generation
